    ...
    void onTapDuration() {
      Picker(
        ...
        onConfirm: (Picker picker, List<int> value) {
          ...
          setState(() {
            userDuration = Duration(hours: picker.getSelectedValues()[0], minutes: picker.getSelectedValues()[1], seconds: picker.getSelectedValues()[2]).inSeconds;
    ...
    void onTapInterval() {
      Picker(
        ...
        onConfirm: (Picker picker, List<int> value) {
          // You get your duration here
          setState(() {
            userInterval = Duration(hours: picker.getSelectedValues()[0], minutes: picker.getSelectedValues()[1], seconds: picker.getSelectedValues()[2]);
            print(userInterval);
